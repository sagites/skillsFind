...
reviewSchema.index({ user: 1, vendor: 1 }, { unique: true }); // Optional: prevents multiple reviews by same user on same vendor
...
// Update rating after saving or removing a review
